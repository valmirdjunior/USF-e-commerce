...
<body class="body-left" onload="verificaTipoPagamento()">
	...
	<div class="section-checkout">
		<div class="section-checkout-view">
			<h4>O número do seu pedido é: ${transacaoSession.id}</h4>
			...
			<button type="submit" class="btn-dpaulla" name="name" onclick="imprimirBoleto()" id="boletoButton">IMPRIMIR BOLETO</button>
		</div>
	</div>
...
function verificaTipoPagamento(){
	if("${transacaoSession.orderPaymentType}" === "1"){
		document.getElementById("boletoButton").style.display = "true";
	}else{
		document.getElementById("boletoButton").style.display = "none";
	}
